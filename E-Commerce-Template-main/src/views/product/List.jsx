  ...
  const getFilteredProducts = () => {
    ...
    if (selectedCategory) {
      filteredProducts = filteredProducts.filter((product) => {
        ...
        return category && typeof category === 'string' && category.toLowerCase() === selectedCategory.toLowerCase();
      });
    }
    ...
    <React.Fragment>
      <div className="container-fluid mb-3">
        <div className="row">
          ...
          <FilterCategory
  onCategoryFilterChange={(category, categoryName, categoryId) => {
    setSelectedCategory(category);  // Update the selected category
    applyFilters(); // Apply filters logic here
  }}
